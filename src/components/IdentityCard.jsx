    ...
    return (
        <section className="relative z-10 px-4 sm:px-8">
            <div className="relative max-w-5xl mx-auto bg-white dark:bg-zinc-900 shadow-xl py-5 rounded-2xl overflow-hidden border border-gray-200 dark:border-zinc-700 transition-all duration-500">
                ...
                {/* İçerik */}
                <div className="relative z-10 p-8 sm:p-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-center">
                    {/* Sol: Başlık + Hobi + Dil + Web */}
                    <div className="flex flex-col gap-6 text-center md:text-left items-center justify-center md:items-center">
                        {/* Başlık ve açıklama bloğu */}
                        ...
                        <div className="flex flex-col items-center md:items-start">
                            ...
                            <ul className="flex flex-wrap gap-3 text-sm text-gray-700 dark:text-gray-300 justify-center md:justify-start">
                            ...
                            <div className="mt-4 w-full">
                                <h3 className="text-lg font-semibold my-1 justify-center flex text-center items-center gap-2 text-indigo-600 dark:text-indigo-400">
                                    <FaLanguage /> {t("languagesTitle")}
                                </h3>
                                <ul className="flex flex-wrap items-center justify-center md:justify-start gap-3 text-sm text-gray-700 dark:text-gray-300">
